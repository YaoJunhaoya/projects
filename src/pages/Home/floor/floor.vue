      ...
      <div class="title clearfix">
        ...
        <div class="fr">
          <ul class="nav-tabs clearfix">
            <li
              class="active"
              v-for="(nl, index) in floors.navList"
              :key="index"
            >
              <a href="#tab1" data-toggle="tab">{{ nl.text }}</a>
            </li>
          </ul>
        </div>
      </div>
      <div class="tab-content">
        <div class="tab-pane">
          <div class="floor-1">
            <div class="blockgary">
              <ul class="jd-list">
                <li v-for="(kw, index) in floors.keywords" :key="index">
                  {{ kw }}
                </li>
              </ul>
            ...
            <div class="floorBanner">
              <!--banner轮播-->
              <!-- 全局组件 -->
              <Carousel :list="floors.carouselList"></Carousel>
            </div>
